...
public class PeliculaRoom {
    ...
    public PeliculaRoom(String title, String overview, String release_date, String url, Integer id, Integer vote_count, Integer vote_average, String backdrop_path, Integer genre_ids) {
        this.title = title;
